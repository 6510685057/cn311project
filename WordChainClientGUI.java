// WordChainClientGUI.java (เพิ่มระบบตั้งชื่อผู้เล่น)
...
public class WordChainClientGUI {
    ...
    public WordChainClientGUI(String serverAddress, int port) {
        askForName();
        setupGUI();
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new WordChainClientGUI("localhost", 10000));
    }
}
